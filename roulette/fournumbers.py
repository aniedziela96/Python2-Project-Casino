...
class FourNumbers(Bet):
    ...
    :type options: list
    :param option: An acceptable bet option (list of four numbers)
    :type option: list
    """
    ...
    def is_option_ok(self, option: list) -> bool:
        ...
        elements from the option must be in options and the length of option must be 4)

        :param option: bet option (list of four numbers)
        :type option: list
